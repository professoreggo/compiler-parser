...
class SemanticAnalyzer:
    def __init__(self, expression, is_float):
...
class TreeVisualizer:
    def __init__(self, root):
        ...
        self.canvas.pack()
        self.draw_tree(self.root, 600, 50, 300, 0)
    ...
    def draw_tree(self, node, x, y, x_offset, depth):
        ...
        new_x_offset = x_offset // 2 if x_offset > 40 else 40
...
# Example usage:
# expression = "y = x * 2 + 2"
# analyzer = SemanticAnalyzer(expression)
